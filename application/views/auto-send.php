		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li>Home</li><li>Auto Send</li><li>Manajemen Auto Send</li>
				</ol>
				<!-- end breadcrumb -->
										...
										<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
									        <thead>
									            <tr>
								                    ...
								                    <th data-hide="phone">Jika Pemohon Memenuhi Syarat</th>
								                    <th data-hide="phone">Maka Sistem Otomatis Mengirim</th>
											...
											<tbody>
												...
												<tr>
									                ...
									                <td><center><a href="<?php echo base_url()?>index.php/auto/editsend/<?php echo $key->id_auto_kirim;?>" class="btn btn-info">edit</a></center></td>
									            </tr>
									            <?php
									            		$i++;
									            	}
