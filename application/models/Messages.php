<?php	
	class Messages extends CI_Model
	{
		...
		function CountMasuk($tahun)
		{
			$this->db->where('year(ReceivingDateTime)',$tahun);
			return $this->db->count_all_results('inbox');
		}
		function CountKeluar($tahun)
		{
			$this->db->where('year(SendingDateTime)',$tahun);
			return $this->db->count_all_results('outbox');
		}
		function CountTerkirimA($tahun)
		{
			$this->db->where('year(SendingDateTime)',$tahun);
